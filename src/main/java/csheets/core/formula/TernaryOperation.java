 ...
 */
public class TernaryOperation extends Operation<TernaryOperator> {
	 ...
	 */
	public TernaryOperation(TernaryOperator operator, Expression leftOperand,
							Expression middleOperand, Expression rightOperand) {
		super(operator);
	...
	public Value evaluate() throws IllegalValueTypeException {
		return middleOperand.evaluate();
		//return operator.applyTo(leftOperand, middleOperand, rightOperand);
	}
	...
	public String toString() {
		return operator.toString() + leftOperand + middleOperand + rightOperand;
	}
}
