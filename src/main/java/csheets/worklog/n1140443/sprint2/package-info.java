 ...
 * Creating, editing and deleting the text notes associated with contacts.
 ...
 * <b>Use Case "Notes Edition-create note":</b> The User initiates the Notes Edition use case.The System displays all contacts.The user selects a contact,writes the note and chooses to create it.The system creates the note and adds it to the repository, and informs the sucess.
 * <b>Use Case "Notes Edition-edit note":</b> The User initiates the Notes Edition use case.The System displays all contacts.The user selects a contact,a note and chooses edits it.The system edits the note and saves it in the repository, and informs the sucess.
 * <b>Use Case "Notes Edition-celete note":</b> The User initiates the Notes Edition use case.The System displays all contacts.The user selects a contact,a note and chooses to delete it.The system deletes the note from the repository, and informs the sucess.
 * <h2>5. Design</h2>
 *
 ...
 * 
 * <code>csheets.domain.Note</code> <code>csheets.ext.notes.NotesController</code>
 ...
 *  Has we enter the second week of the project, we start to develop features for the contacts.
 * 
