 ...
 * 
 * <p>
 * <b>Use Case "Notes Edition-create":</b> The User initiates the Notes Edition use case by selecting a contact. The system shows 3 options(create,edit,delete) for the text notes, of the contact.The user selects "create" and writes the note.The system updates the history log of the note and saves the note, to its previous chosen contact.
 * <b>Use Case "Notes Edition-edit":</b> The User initiates the Notes Edition use case by selecting a contact. The system shows 3 options(create,edit,delete) for the text notes, of the contact.The user selects "edit".The system displays the chosen note for editing. the user edits the note and presses de save button .The system updates the history log of the note and saves the note, to its previous chosen contact.
 *  <b>Use Case "Notes Edition-delete":</b> The User initiates the Notes Edition use case by selecting a contact. The system shows 3 options(create,edit,delete) for the text notes, of the contact.the user selects "delete".The system shows a list of the notes to the chosen contact.the user chooses which one he wants to delete.The System deletes it, and updates the note's list for the previous chosen contact
 * <h2>4. Analysis</h2>
 * 
 * 
