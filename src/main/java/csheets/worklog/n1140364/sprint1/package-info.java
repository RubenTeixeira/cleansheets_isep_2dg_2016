/**
 * Technical documentation regarding the work of the team member (1140364) josé Barros during week1.
 *
 * <p>
 ...
 * <h2>4. Analysis</h2>
 * <h3>Send Cells</h3>
 * The user selects "Send Cells" option in the "Share Cells" menu. The system
 * gets the other available instances in the local network, and presents them in
 * a sidebar window. The user selects which instance to send the cells to, and
 * activates the sending. The system gets the selected cells, and sends them to
 * the targeted instance. The system notifies the user that the cells were sent.
 *
 * <h3>Receive Cells</h3>
 * The user selects "Receive Cells" option in the "Share Cells" menu. The system
 ...
 * @author José Barros
 */
package csheets.worklog.n1140364.sprint1;
