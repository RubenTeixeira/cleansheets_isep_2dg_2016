 ...
 * <h2>1. Notes</h2>
 * 
 * Helped my colleagues throughout the sprint in regards to Volt and network/thread related questions.
 * 
 ...
 * 
 * <b>Update</b>: Since the last few days I've written a unified service to serve our extension needs, I've decided to update the design diagram.
 * It is a bit more complete, but essentially it's nearly identical as we just have to declare the channel Volt is filtrating the message and expect for a route.
 * 
 ...
 * We are going to manually test the network to see expected results.
 * </p>
 * 
 * 
 ...
 * 
 * <p>
 * In regards to implementation, most of the feature implementation is done through Volt. Since Volt already supports Channels for Encryption and Decryption and as well as 
 * watch who receives and sends messages, the feature is easily implemented.
 * </p>
 * <p>
 * Channels are a way to filter the message input & output in certain points of Volt's execution. The Channels have 2 hook methods which are before() and after(), which allows us to execute
 * actions before and after the Volt execution. This allows for some very powerful data manipulation, yet incredibly simple.
 * </p>
 * 
 * <p>
 * As for Encryption, Volt uses AES-128 bits encryption which requires a key to both encrypt and decrypt messages. This class is available in Volt's package.
 * </p>
 ...
 * <p>Tuesday</p>
 * <p>Today</p>
 * <p>Going to work a bit on unifying the multiple network services into one service. Going to make some improvements into Volt.</p>
 * <p>Blocking</p>
 * <p>Nothing</p>
 * 
 * <p>08/06/2016</p>
 * <p>Wednesday</p>
 * <p>Yesterday</p>
 * <p>Implemented the Volt static class and made some small improvements to it.</p>
 * <p>Today</p>
 * <p>Will finish my use case by implementing the User Interface and the associated controller following the design. Test my use case and update the overall documentation.</p>
 * <p>Blocking</p>
 * <p>Nothing</p>
 * 
 * <h2>10. Self Assessment</h2> 
 * 
 * <p>Outcome 3 ("Design and Implementation") -4</p>
 * <p>Outcome 5 ("Teamwork") - 3</p>
 * <p>Outcome 6 ("Technical Documentation") - 4</p>
 *
 ...
 * </p>
 * <p>
 * <p><a href="https://bitbucket.org/lei-isep/lapr4-2016-2dg/commits/b8cf8e3950952c780501d4618af5b4626b086452">Analysis</a></p>
 * <p><a href="https://bitbucket.org/lei-isep/lapr4-2016-2dg/commits/41c3c827ab8a71cbcf35f881f617e5534537eb84">Base design</a></p>
 * <p><a href="https://bitbucket.org/lei-isep/lapr4-2016-2dg/commits/941200bbd1397d028114571cfaf36d3c0bf80e20">Improved Volt performance and documentation. Added new features to Volt: Channels and Dependencies. Added Encrypter.</a></p>
 * <p><a href="https://bitbucket.org/lei-isep/lapr4-2016-2dg/commits/4f27d5ab684c3fbb892412d6ba8d8ef9887c2811">Added the ability for Volt to handle multiple concurrent services.</a></p>
 * <p><a href="https://bitbucket.org/lei-isep/lapr4-2016-2dg/commits/f1f002968d1da85a6d73db628982edaf9777a861">Updated feature UI and Controller. Updated Volt.</a></p>
 * <p><a href="https://bitbucket.org/lei-isep/lapr4-2016-2dg/commits/3c6e1ab1a01b3d9e20f8864ed7096c855eabee7e">Added the NetworkManager</a></p>
 * </p>
 * 
 * <h3>10.2. Teamwork: ...</h3>
 * 
