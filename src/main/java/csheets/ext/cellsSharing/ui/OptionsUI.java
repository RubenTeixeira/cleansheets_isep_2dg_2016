                ...
                .addGroup(optionsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(optionsPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(optionsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtTimer, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(optionsPanelLayout.createSequentialGroup()
                        .addGap(95, 95, 95)
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
		...
		if (!txtPort.getText().isEmpty() && !txtTimer.getText().isEmpty()) {
			...
			if (port <= 0 || timer < 0) {
				...
				// Creates controller
				//controller = new ShareCellsController(uiController, port, timer);
				controller = new ShareCellsController(uiController, new SharePanel(uiController), port);
