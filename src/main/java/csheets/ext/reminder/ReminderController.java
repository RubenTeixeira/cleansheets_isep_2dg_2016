...
import csheets.ext.reminder.ui.RemindersListModel;
...
public class ReminderController {
    ...
    public RemindersListModel getReminders() {
        ArrayList<Reminder> list = new ArrayList();
        Iterable<Reminder> iterable = PersistenceContext.repositories().reminders().all();
        for (Reminder reminder : iterable) {
            list.add(reminder);
        }
        return new RemindersListModel(list);
