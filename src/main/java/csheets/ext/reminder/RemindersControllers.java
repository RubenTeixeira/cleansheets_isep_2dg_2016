...
public class RemindersControllers {
	 ...
	 */
	public RemindersControllers(UIController uiController,
								RemindersPanel uiPanel) {
		this.uiController = uiController;
		this.uiPanel = uiPanel;
	}

	public Reminder createReminder(String nameReminder, String dscReminder,
								   Calendar calendar) throws DataIntegrityViolationException {
		Reminder reminder = ReminderFactory.
			createReminder(nameReminder, dscReminder, calendar);
