 ...
 */
public class UIExtensionNotes extends UIExtension {
	 ...
	 */
	public UIExtensionNotes(Extension extension, UIController uiController) {
	...
	public JComponent getSideBar() {
		if (sideBar == null) {
			sideBar = new NotesPanel(uiController);
		}
		return sideBar;
	}
}
