 ...
 * @author Rui Bastos
 */
public class ContactsManage2 extends javax.swing.JPanel implements Observer {
	...
	public void createEvent() {
		...
		if (DateTime.now().before(calendar)) {
			if (this.contact == null) {
				...
				this.contact.
					defineEvent(this.contact, this.jTextFieldEventName.
								getText(), calendar, this.checkboxActive.
								getState());
				this.controller.editEvent(this.contact);
			}
		} else {
			JOptionPane.
