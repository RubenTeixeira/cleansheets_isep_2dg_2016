...
public class TaskPanelSingle extends javax.swing.JPanel implements Observer {
    ...
    public void update(Observable o, Object o1) {
        if (this.task != null) {
            ...
            this.lblYear.setText(String.valueOf(DateTime.year(this.task.getDate()))+"/");
            this.lblMonth.setText(String.valueOf(DateTime.month(this.task.getDate()))+"/");
            this.lblDay.setText(String.valueOf(DateTime.day(this.task.getDate())));
        }
    }
}
