...
/**
 * An action of the agenda extension  to interact with the
 * spreadsheet.
 *
 * @author AB-1140280
 */
public class AgendaAction extends BaseAction {
	...
	/**
	 * A simple action that presents a agenda frame. Which allows the user to see all available events
         * of a contact
	 *
	...
	public void actionPerformed(ActionEvent event) {
		new AgendaFrame(uiController).setVisible(true);
	}
}
