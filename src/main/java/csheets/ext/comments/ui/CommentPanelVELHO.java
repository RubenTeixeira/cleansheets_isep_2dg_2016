...
// *
// * CleanSheets Extension for Assetrions is free software; you can
...
//public class CommentPanelVELHO extends JPanel implements SelectionListener,
...
//	 */
//	public CommentPanelVELHO(UIController uiController) {
//		// Configures panel
...
//		boolean valid = controller.cellSelected(cell);
//		if (valid) {
//			setCommentText(cell.getUserName(), cell.
//						   getUserComment().trim());
//		} else {
//			setCommentText("", "");
//		}
//	}
//
//	public void setCommentText(String username, String comment) {
//		commentField.setText(username + comment);
//	}
//
...
//				controller.
//					setComment(cell, commentField.getText().trim(), userName);
//			}
//		}
//	}
//}
