...
public class Request {
    ...
    /**
     * Puts a new username on the "username" argument.
     *
     * @param username New username.
     */
    public void username(String username) {
        this.args.put("volt-username", username);
    }
    
    /**
     * Gets the requester username from his machine.
     * 
     * @return Requester username.
     */
    public String username()
    {
        return (String) this.args.get("volt-username");
    }
