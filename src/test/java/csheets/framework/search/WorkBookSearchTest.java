...
public class WorkBookSearchTest {
    ...
    public void ensureGetMatchesWorksAsIntended() {
        ...
        try {
            ...
            ((CommentableCell) workBook.getSpreadsheet(0).getCell(0, 3).getExtension(CommentsExtension.NAME)).addComment("Test", "adcwd4cecec9");
    ...
    public void searchForErrorAndBoolean() {
        ...
        int expResult = 2;
        int result = instance.getMatches(pattern2, errorMoneyTypes, false, false).size();
        assertEquals(expResult, result);
    }
