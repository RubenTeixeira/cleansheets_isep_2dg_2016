...
public class TaskControllerTest {
    ...
    public void setUp() throws DataIntegrityViolationException {
       ...
       PersistenceContext.repositories().contacts().save(contact);
        ...
        reminderController.createReminder("São João", "Feriado São João", calendar, false);
        event = new Event(contactCalendar, "Evento 1", DateTime.newCalendar(2016, 6, 20), DateTime.newCalendar(2016, 6, 28));
...
//        fail("The test case is a prototype.");
    ...
    public void testCreateTask() throws Exception {
        ...
        Task result = taskController.createTask(taskName, description, priority, percentageofcompletion, contact, this.event);
        assertEquals("newTaskDescription", PersistenceContext.repositories().task().all().iterator().next().Description());
    }
